...
const Hero = () => {
  return (
    <div className='container-fluid hero mt-5'>
      <div className='row'>
        <div className='col-lg-10 mx-auto'>
          ...
          <p className='col-lg-8 pl-0 mt-4 mb-4 hero__whatIDo'>
            I'm primarily a front-end software engineer focused on building
            websites & web applications. I also have some experience with
